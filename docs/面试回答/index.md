...
| 回答稿 | 难度 | 频次 | 状态 | 核心问题 |
|--------|------|------|------|---------|
| [语义化 / DOCTYPE / em vs i](./HTML/semantic-doctype.md) 🆕 | 初级 | ⭐⭐⭐⭐⭐ | draft | 语义标签三大价值 / DOCTYPE 怪异模式 / em vs i |
| [script 加载 / 懒加载 / Resource Hints](./HTML/script-lazy-loading.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | defer vs async / 图片懒加载 / preload vs prefetch |
| [viewport / HTML5 表单](./HTML/form-meta-viewport.md) 🆕 | 初级 | ⭐⭐⭐⭐ | draft | 三视口 / 约束验证 API / CSS 校验伪类 |
| [Canvas vs SVG / History API](./HTML/canvas-svg-history.md) 🆕 | 中级 | ⭐⭐⭐⭐ | draft | Canvas 位图 vs SVG 矢量 / pushState vs replaceState |
...
| [async/await](./JavaScript/async-await.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | Generator 语法糖 / 性能陷阱 / try-catch |
| [深拷贝](./JavaScript/deep-clone.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | WeakMap 循环引用 / Date/Map/Set / Reflect.ownKeys |
| [new 操作符](./JavaScript/new-operator.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | 四步分解 / 手写 myNew / 箭头函数限制 |
| [var / let / const](./JavaScript/var-let-const.md) 🆕 | 初级 | ⭐⭐⭐⭐⭐ | draft | TDZ 深度解释 / var 三坑 / const 引用锁定 |
| [Promise 并发调度](./JavaScript/promise-scheduler.md) 🆕 | 高级 | ⭐⭐⭐⭐⭐ | draft | 并发限制 / 递归驱动 / 滑动窗口 |
| [defineProperty vs Proxy](./JavaScript/defineproperty-proxy.md) 🆕 | 中级 | ⭐⭐⭐⭐ | draft | Proxy 13 拦截 / Vue2→Vue3 升级逻辑 |
...
| [水平垂直居中](./CSS/centering.md) | 中级 | ⭐⭐⭐⭐⭐ | draft | 5 种方案 / 选型决策 / transform 缺陷 |
| [选择器优先级](./CSS/specificity.md) | 中级 | ⭐⭐⭐⭐⭐ | draft | 权重计算 / !important 真规则 / @layer 新规 |
| [元素隐藏三种方式](./CSS/display-visibility-opacity.md) 🆕 | 初级 | ⭐⭐⭐⭐⭐ | draft | display:none/visibility:hidden/opacity:0 三维对比 |
...
| 回答稿 | 难度 | 频次 | 状态 | 核心问题 |
|--------|------|------|------|---------|
| [泛型 / 工具类型](./TypeScript/generics-utility.md) | 高级 | ⭐⭐⭐⭐⭐ | draft | 泛型本质 / Pick/Omit/Partial/Record/Exclude/ReturnType 全实现 |
| [interface vs type](./TypeScript/interface-type-answer.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | 声明合并 / 表达能力 / extends 方式三区别 + 项目选择 |
...
| [extends / infer](./TypeScript/extends-infer-answer.md) 🆕 | 高级 | ⭐⭐⭐⭐ | draft | extends 三种身份 / infer 提取 / 分布式条件类型陷阱 |
| [keyof / 映射 / 条件类型](./TypeScript/keyof-mapped-conditional-answer.md) 🆕 | 高级 | ⭐⭐⭐⭐ | draft | 三板斧递进逻辑 / 组合模式 / PickByValueType 实战 |
...
| [类型体操](./TypeScript/type-gymnastics-answer.md) 🆕 | 高级 | ⭐⭐⭐ | draft | DeepReadonly/DeepPartial 递归 / 实用价值与边界 |
| [协变 / 逆变](./TypeScript/covariance-contravariance-answer.md) 🆕 | 高级 | ⭐⭐⭐⭐ | draft | 参数逆变反例 / strictFunctionTypes / Array 协变陷阱 |
...
| [浏览器存储方案](./浏览器/storage.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | Cookie/localStorage/sessionStorage/IndexedDB 对比选型 |
...
| [DNS / CDN](./网络/dns-cdn.md) 🆕 | 中级 | ⭐⭐⭐⭐ | draft | DNS 递归+迭代 / CDN 三技术 / 缓存一致性 |
...
| [构建优化实战](./工程化/build-optimization.md) | 高级 | ⭐⭐⭐⭐⭐ | draft | 四层优化 / 量化数据 / 180s→40s / 分包策略 |
| [Tree Shaking / HMR](./工程化/tree-shaking-hmr.md) 🆕 | 高级 | ⭐⭐⭐⭐ | draft | Tree Shaking 三步骤+五失效场景 / HMR 四步流程 |
| [ESM / CJS 模块化](./工程化/esm-cjs.md) | 中级 | ⭐⭐⭐⭐ | draft | 三核心区别 / 值拷贝 vs 值引用 / Tree Shaking 前提 |
...
| 回答稿 | 难度 | 频次 | 状态 | 核心问题 |
|--------|------|------|------|---------|
| [history vs hash](./VueRouter/history-hash.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | hash 模式 / history 模式 / Nginx 部署 / 选型 |
| [动态路由 / 权限路由](./VueRouter/dynamic-routing.md) 🆕 | 高级 | ⭐⭐⭐⭐⭐ | draft | addRoute 流程 / 权限系统 / 退出清理 |
| [路由守卫](./VueRouter/route-guards.md) | 中级 | ⭐⭐⭐⭐⭐ | draft | 三层守卫体系 / addRoute 动态权限 / beforeEach 鉴权 |

### Pinia（1 篇）

| 回答稿 | 难度 | 频次 | 状态 | 核心问题 |
|--------|------|------|------|---------|
| [Pinia vs Vuex](./Pinia/pinia-vs-vuex.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | 去 mutations / setup store / TS 类型推导 |

### 性能优化（4 篇）

| 回答稿 | 难度 | 频次 | 状态 | 核心问题 |
|--------|------|------|------|---------|
| [首屏优化](./性能优化/first-screen.md) 🆕 | 高级 | ⭐⭐⭐⭐⭐ | draft | 四步优化链路 / LCP 3.2s→1.1s / 量化效果 |
| [Web Vitals](./性能优化/web-vitals.md) 🆕 | 中级 | ⭐⭐⭐⭐ | draft | LCP/INP/CLS 三指标 / INP 替代 FID / 优化方向 |
| [虚拟列表](./性能优化/virtual-list.md) 🆕 | 高级 | ⭐⭐⭐⭐ | draft | 固定高度三步 + 动态高度二分 + buffer 优化 |
| [缓存策略](./性能优化/caching-strategy.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | 四层体系 / 按资源分配策略 / no-cache vs no-store |

> 已填充：67 篇。每篇包含 30 秒版 + 2 分钟版 + 追问预判 + 别踩的坑。
