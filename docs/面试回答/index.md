...
| [ESM / CJS 模块化](./工程化/esm-cjs.md) 🆕 | 中级 | ⭐⭐⭐⭐ | draft | 三核心区别 / 值拷贝 vs 值引用 / Tree Shaking 前提 | 🆕 | 高级 | ⭐⭐⭐⭐ | draft | Tree Shaking 三步骤+五失效场景 / HMR 四步流程 |
...
| 回答稿 | 难度 | 频次 | 状态 | 核心问题 |
|--------|------|------|------|---------|
| [路由守卫 / 动态路由](./VueRouter/route-guards.md) 🆕 | 中级 | ⭐⭐⭐⭐⭐ | draft | 三层守卫体系 / addRoute 动态权限 / beforeEach 鉴权 |
...
> 已填充：60 篇。每篇包含 30 秒版 + 2 分钟版 + 追问预判 + 别踩的坑。
