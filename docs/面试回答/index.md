...
|--------|------|------|------|------|---------|
| [Promise](./JavaScript/promise.md) | JavaScript | 中级 | ⭐⭐⭐⭐⭐ | 已完成 | 链式调用 / async-await 区别 / 手写 Promise |
| [Vue3 响应式原理](./Vue3/reactivity.md) | Vue3 | 高级 | ⭐⭐⭐⭐⭐ | 已完成 | 响应式原理 / 为什么比 Vue2 快 / ref vs reactive |
| [登录鉴权](./项目/login-auth.md) | 项目实战 | 中级 | ⭐⭐⭐⭐⭐ | 已完成 | 登录方案 / Token 刷新 / 权限系统设计 |

> 已填充：3 篇。每篇包含 3 道核心问题的逐字回答稿，每道题回答约 2 分钟（300--400 字），附带面试官常见追问及应对策略。
