...
### Q2: computed | 对比题 vs watch 区别与原理
...
### Q15: 自定义指令 | 概念题（Custom Directive）
...
### Q17: Vue 事件总线手写 ($on/$emit/$off/$once)

> ⭐⭐ | 难度：中级

> 📌 2026 该题作为 Vue3 独立题几乎绝迹——考法退化为 Q12 组件通信的追问。通用 EventEmitter 手写见手写题模块：[event-emitter](../手写题/event-emitter.md)
...
### Q18: Composition | 对比题 API vs Options API
