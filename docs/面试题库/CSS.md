...
### Q4: `content-box` 和 `border-box` 有什么区别？为什么要全局设置 `border-box`？⭐⭐⭐⭐⭐
...
### Q6: 外边距重叠（Margin Collapse）是什么？如何解决？⭐⭐⭐⭐
...
### Q13: CSS 优先级怎么计算？`!important` 一定最高吗？⭐⭐⭐⭐⭐
...
### Q14: `@layer` 解决了什么问题？和选择器优先级是什么关系？⭐⭐⭐
...
### Q15: `display:none`、`visibility:hidden`、`opacity:0` 三种隐藏方式的区别？⭐⭐⭐⭐⭐
...
### Q16: `transition` 和 `animation` 有什么区别？⭐⭐⭐⭐
...
### Q20: 容器查询 `@container` 和 `:has()` 解决了什么问题？⭐⭐⭐⭐
...
### Q21: 哪些 CSS 属性触发回流、重绘、仅合成？动画为什么首选 transform/opacity？⭐⭐⭐⭐
...
### Q22: 如何清除浮动？clearfix 和 BFC 方案有什么区别？⭐⭐⭐
