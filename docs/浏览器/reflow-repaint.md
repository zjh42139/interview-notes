...
CSS Triggers 曾整理过每个属性的触发阶段（csstriggers.com 域名已于 2022 年失效，可查 [Wayback Machine 存档](https://web.archive.org/web/20220727225220/https://csstriggers.com/)）。记住几个关键结论：
...
- [CSS Triggers（Wayback Machine 存档，原站已失效）](https://web.archive.org/web/20220727225220/https://csstriggers.com/)
