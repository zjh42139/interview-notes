...
3. ⭐⭐⭐⭐ [fetch vs pull](./fetch-vs-pull.md) — 远程同步的正确姿势
4. ⭐⭐⭐⭐⭐ [冲突处理](./conflict-resolution.md) — 合并的自然延伸
5. ⭐⭐⭐⭐ [reset vs revert](./reset-vs-revert.md) — 撤销是另一面
6. ⭐⭐⭐⭐ [stash](./stash.md) — 未提交代码的管理

### 二、分支操作（建立在核心操作上）

7. ⭐⭐⭐⭐ [cherry-pick](./cherry-pick.md) — 跨分支选择提交
8. ⭐⭐⭐ [tag](./tag.md) — 为提交打标记

### 三、工作流与调试

9. ⭐⭐⭐⭐ [Git Flow](./git-flow.md) — 在核心操作上的流程组织
10. ⭐⭐⭐⭐ [reflog/rebase -i/内部原理](./reflog-rebase-interactive.md) — 理解内部机制
11. ⭐⭐⭐ [diff/log/blame/hooks](./diff-log-blame-hooks.md) — 调试和自动化
12. ⭐⭐⭐ [bisect](./bisect.md) — 调试大杀器
...
| [fetch vs pull](./fetch-vs-pull.md) | ⭐⭐⭐⭐ | 初级 | filled |
...
- 2026-07-18：新增 fetch vs pull 知识点，更新学习顺序、索引表
- 2026-07-06：初始创建
