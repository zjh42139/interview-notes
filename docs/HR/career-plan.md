...
>
> 为什么我觉得自己能做到短期目标？因为过去三年我已经证明了自己有持续学习的习惯和能力。我刚毕业的时候只会 jQuery，后来自学 Vue2 到 Vue3、从 JavaScript 迁移到 TypeScript、从 Webpack 切到 Vite——每一次技术栈的升级都是我自己主动推动的，不是被项目逼着学的。这说明我有**自学能力和技术敏感度**，这两点是实现短期规划的基础。
>
