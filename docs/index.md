...
6. **串链**：每周画一次 [跨模块知识链](./阅读指南.md#-跨模块知识链p0-核心任务)——白纸脱稿，从起点到终点，每个箭头旁写因果关系
...
| 模块 | 文章 | 说明 |
|------|------|------|
| [JavaScript](JavaScript/) | 23 | this / 闭包 / 原型链 / Promise / Event Loop / async-await / 类型转换 / 模块化 |
...
| [浏览器](浏览器/) | 31 | 渲染流程 / 缓存 / XSS/CSRF/CSP / V8 / 内存泄漏 / GC / Service Worker / 跨标签页 |
...
| 模块 | 文章 | 说明 |
|------|------|------|
| [TypeScript](TypeScript/) | 17 | 基础类型 / 泛型 / extends infer / Utility Types / 声明文件 / tsconfig / Vue3+TS |
| [Vue Router](VueRouter/) | 10 | history/hash / 动态路由 / 路由守卫 / KeepAlive 集成 / 导航故障 |
...
| [架构设计](前端架构/) | 11 | 项目分层 / 组件设计 / 设计模式 / 插件化 / 配置化 / qiankun / Module Federation |
...
| 模块 | 文章 | 说明 |
|------|------|------|
| [算法](算法/) | 14 | 排序 / 树 / DP / DFS/BFS / 滑动窗口 / 双指针 |
| [手写题](手写题/) | 16 | Promise / bind / 深拷贝 / EventEmitter / LRU / 并发控制 |
...
| 模块 | 文章 | 说明 |
|------|------|------|
| [面试题库](面试题库/) | 19 | HTML / CSS / JS / TS / Vue3 / 浏览器 / 网络 / 工程化 / 手写题 / 算法 / 安全 |
| [面试回答](面试回答/) | 74 | 逐字回答稿：30 秒版 + 2 分钟版 + 追问预判 / 覆盖 11 个模块 |
| [模拟面试](模拟面试/) | 6 | 完整面试流程脚本——3 轮一面 + 二面 + 三面 |
| [项目实战](项目实战/) | 25 | 登录鉴权 / 权限 RBAC / 大文件上传 / ECharts / 国际化 / 错误监控 |
| [HR](HR/) | 8 | 自我介绍 / 离职原因 / 职业规划 / 优缺点 / 薪资谈判 / 反问面试官 |
