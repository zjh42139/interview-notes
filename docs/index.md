...
graph TB
    subgraph 口述层[" "]
        ANSWER["🎤 面试回答<br/>67 篇逐字稿"]
    end

    subgraph 支柱["四大核心支柱"]
        JS["JavaScript<br/>23 篇"]
        VUE["Vue3<br/>22 篇"]
        TS["TypeScript<br/>17 篇"]
        BROWSER["浏览器<br/>30 篇"]
    end
    ...
    JS & VUE & NET & CSS & BROWSER & TOOLS --> PROJECT

    style ANSWER fill:#ffd700,stroke:#333
    style PROJECT fill:#4caf50,stroke:#333
```

> 图中箭头表示知识依赖——A→B 意味着"理解 B 需要先掌握 A"。核心学习路径：**四根支柱打底 → 横向基础扩展 → 工程实践落地**。
...
| [项目实战](项目实战/) | 19 | 登录鉴权 / 权限 RBAC / 大文件上传 / ECharts / 国际化 / 错误监控 |
